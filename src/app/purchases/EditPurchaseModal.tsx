...
import { useUpdatePurchaseMutation } from "@/state/api"
...
const EditPurchaseModal = ({ isOpen, onClose, purchase, products }: EditPurchaseModalProps) => {
